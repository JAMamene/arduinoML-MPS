...
/*package*/ class Condition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = MetaAdapterFactory.getProperty(0x6d5f556878454ac1L, 0xba976d57e4d58942L, 0x7c71bdff0dc570e5L, 0x7c71bdff0dc570e6L, "value");
      ...
      if (_StyleParameter_QueryFunction_2lgv54_a0a0()) {
        new highStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
      }
      if (_StyleParameter_QueryFunction_2lgv54_a1a0()) {
  ...
  private boolean _StyleParameter_QueryFunction_2lgv54_a0a0() {
    return SPropertyOperations.getString(getNode(), MetaAdapterFactory.getProperty(0x6d5f556878454ac1L, 0xba976d57e4d58942L, 0x7c71bdff0dc570e5L, 0x7c71bdff0dc570e6L, "value")) == SEnumOperations.getMemberName(SEnumOperations.getMember(0x6d5f556878454ac1L, 0xba976d57e4d58942L, "ArduinoML", 0x3c2a1b6d4a4685f5L, "SIGNAL", 0x3c2a1b6d4a4685f7L, "HIGH"));
  }
  private boolean _StyleParameter_QueryFunction_2lgv54_a1a0() {
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_2lgv54_a1a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
